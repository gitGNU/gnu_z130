...
#define TIGER_INITIAL_A = 0x0123456789ABCDEF;
#define TIGER_INITIAL_B = 0xFEDCBA9876543210;
#define TIGER_INITIAL_C = 0xF096A5B4C3B2E187;
#define TIGER_INITIAL_REGISTERS = {0x0123456789ABCDEF, 0xFEDCBA9876543210, 0xF096A5B4C3B2E187}
